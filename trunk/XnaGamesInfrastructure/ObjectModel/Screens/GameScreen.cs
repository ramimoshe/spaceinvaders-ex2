...
namespace XnaGamesInfrastructure.ObjectModel.Screens
{
    ...
    public abstract class GameScreen : CompositeDrawableComponent<IGameComponent>
    {
        ...
        protected eScreenState m_State = eScreenState.Deactive;
        ...
        {
            if (this.State == eScreenState.Deactive
        ...
        protected internal virtual void Deactivate()
        {
                ...
                || this.State == eScreenState.Activating)
            {
                ...
                {
                    this.State = eScreenState.Deactive;
                }
            }
        }
        ...
        public TimeSpan ActivationLength
        {
            get
            {
                return m_ActivationLength;
            }
            protected set
            {
                m_ActivationLength = value;
            }
        }
        ...
        public TimeSpan DeactivationLength
        {
            get
            {
                return m_DeactivationLength;
            }
            protected set
            {
                m_DeactivationLength = value;
            }
        }
        ...
        public bool UseFadeTransition
        {
            get
            {
                return m_UseFadeTransition;
            }
            set
            {
                m_UseFadeTransition = value;
            }
        }
